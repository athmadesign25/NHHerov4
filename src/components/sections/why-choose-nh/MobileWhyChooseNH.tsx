...
import styles from "./MobileWhyChooseNH.module.css";
...
export default function MobileWhyChooseNH() {
  ...
  useEffect(() => {
    const measure = () => {
      const titleEl = document.getElementById("mobile-app-download-title-unit");
      if (!titleEl) return;
