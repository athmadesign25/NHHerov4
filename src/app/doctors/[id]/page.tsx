      ...
      <div className="container" style={{ padding: "var(--sp-4) var(--sp-3)", maxWidth: 1320 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 480px", gap: "var(--sp-4)", alignItems: "start" }}>
          ...
          <div style={{ position: "sticky", top: "calc(var(--nav-height) + 24px)", background: "var(--color-bg-card)", borderRadius: 16, border: "1px solid var(--color-border)", padding: "var(--sp-4)", boxShadow: "var(--shadow-sm)" }}>
            ...
            <a href="tel:18001030" id="doctor-call-btn" style={{ width: "100%", padding: "12px", border: "1.5px solid var(--color-primary)", color: "var(--color-primary)", fontWeight: 600, fontSize: "var(--font-size-sm)", borderRadius: "100px", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, transition: "background-color 0.15s", textDecoration: "none" }}
